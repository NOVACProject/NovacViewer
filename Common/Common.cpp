...
double Common::CalculateFlux(const double *scanAngle, const double *scanAngle2, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor, INSTRUMENT_TYPE type, double coneAngle, double tilt){
...
double Common::CalculateFlux_FlatFormula(const double *scanAngle, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor){
...
double Common::CalculateFlux_ConeFormula(const double *scanAngle, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor, double coneAngle, double tilt){
	double flux = 0;
...
double Common::CalculateFlux_HeidelbergFormula(const double *scanAngle1, const double *scanAngle2, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor){
	double flux = 0;
	double partialFlux;
