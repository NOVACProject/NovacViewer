...
// signals to the CDataImporter that the date has changed
#define WM_CHANGED_DATE		        WM_USER + 13
...
public:
	...
	static double CalculateFlux(const double *scanAngle, const double *scanAngle2, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor, INSTRUMENT_TYPE type, double coneAngle = 90.0, double tilt = 0.0);

	/** Calculates the flux for the supplied data using the old algorithm */
	static double CalculateFlux_FlatFormula(const double *scanAngle, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor);

	/** Calculates the flux for the supplied data using the new algorithm */
	static double CalculateFlux_ConeFormula(const double *scanAngle, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor, double coneAngle, double tilt);

	/** Calculates the flux for the Heidelberg-instrument for the supplied data using the general algorithm */
	static double CalculateFlux_HeidelbergFormula(const double *scanAngle1, const double *scanAngle2, const double *column, double offset, int nDataPoints, const CWindFieldAndPlumeHeight &wind, double compass, double gasFactor);
