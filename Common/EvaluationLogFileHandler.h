...
//#define MAX_N_SCANS 800
	...
	public:
		...
		static bool GetInfoFromFileName(const CString fileName, CDateTime &start, CString &serial, int &channel);
	...
	protected:
		...
		void ParseFluxInformation(CWindFieldAndPlumeHeight &windField, double &flux, FILE *f);
