#include "StdAfx.h"
#include "WindFieldAndPlumeHeight.h"

CWindFieldAndPlumeHeight::CWindFieldAndPlumeHeight(void)
{
...
/** assignment operator */
CWindFieldAndPlumeHeight &CWindFieldAndPlumeHeight::operator=(const CWindFieldAndPlumeHeight &wf2){
...
/** Sets the wind-speed */
void CWindFieldAndPlumeHeight::SetWindSpeed(double ws, MET_SOURCE source){
	this->m_windSpeed				= ws;
	this->m_windSpeedSource			= source;
}

/** Sets the wind-speed */
void CWindFieldAndPlumeHeight::SetWindSpeed(double ws, MET_SOURCE source, double wsError){
	this->m_windSpeed				= ws;
	this->m_windSpeedSource			= source;
...
void CWindFieldAndPlumeHeight::SetWindDirection(double wd, MET_SOURCE source){
	this->m_windDirection				= wd;
	this->m_windDirectionSource			= source;
}

/** Sets the wind-speed */
void CWindFieldAndPlumeHeight::SetWindDirection(double wd, MET_SOURCE source, double wdError){
	this->m_windDirection				= wd;
	this->m_windDirectionSource			= source;
...
void CWindFieldAndPlumeHeight::SetPlumeHeight(double ph, MET_SOURCE source){
	this->m_plumeHeight				= ph;
	this->m_plumeHeightSource		= source;
}

/** Sets the plume height */
void CWindFieldAndPlumeHeight::SetPlumeHeight(double ph, MET_SOURCE source, double phError){
	this->m_plumeHeight				= ph;
	this->m_plumeHeightSource		= source;
...
void CWindFieldAndPlumeHeight::SetAltitude(double altitude){
	this->m_altitude = altitude;
}

/** Sets the time and/or date the wind-field is valid for */
void CWindFieldAndPlumeHeight::SetTimeAndDate(const CDateTime &dt){
	this->m_time = dt;
}

/** Sets the time the wind-field is valid for */
void CWindFieldAndPlumeHeight::SetTime(int hour, int minute, int second){
	m_time.hour		= hour;
...
void CWindFieldAndPlumeHeight::SetDate(int year, int month, int day){
	m_time.year		= year;
	m_time.month	= month;
	m_time.day		= day;
}
...
/** Gets the wind-speed */
double CWindFieldAndPlumeHeight::GetWindSpeed() const{
	return this->m_windSpeed;
}

/** Gets the source of the wind-speed */
MET_SOURCE CWindFieldAndPlumeHeight::GetWindSpeedSource() const{
	return this->m_windSpeedSource;
}

/** Gets the source of the wind-speed */
void CWindFieldAndPlumeHeight::GetWindSpeedSource(CString &str) const{
...
double CWindFieldAndPlumeHeight::GetWindDirection() const{
	return this->m_windDirection;
}

/** Gets the source of the wind-direction */
MET_SOURCE CWindFieldAndPlumeHeight::GetWindDirectionSource() const{
	return this->m_windDirectionSource;
}

/** Gets the source of the wind-direction */
void CWindFieldAndPlumeHeight::GetWindDirectionSource(CString &str) const{
...
double CWindFieldAndPlumeHeight::GetPlumeHeight() const{
	return this->m_plumeHeight;
}

/** Gets the source of the plume-height */
MET_SOURCE CWindFieldAndPlumeHeight::GetPlumeHeightSource() const{
	return this->m_plumeHeightSource;
}

/** Gets the source of the plume-height */
void CWindFieldAndPlumeHeight::GetPlumeHeightSource(CString &str) const{
...
const CDateTime &CWindFieldAndPlumeHeight::GetTimeAndDate() const{
	return this->m_time;
}

/** Gets the estimate for the total error in the wind-field */
double	CWindFieldAndPlumeHeight::GetWindError() const{
	return m_windError;
}

/** Sets the estimate for the total error in the wind-field */
void	CWindFieldAndPlumeHeight::SetWindError(double err){
	m_windError = err;
}
