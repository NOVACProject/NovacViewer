...
#ifndef WINDFIELDANDPLUMEHEIGHT_H
#define WINDFIELDANDPLUMEHEIGHT_H

/** <b>CWindFieldAndPlumeHeight</b> is a generic data structure to contain information about 
    winds, windfields and metrology. */
class CWindFieldAndPlumeHeight
{
public:
	CWindFieldAndPlumeHeight(void);

	~CWindFieldAndPlumeHeight(void);

	/** assignment operator */
	CWindFieldAndPlumeHeight &operator=(const CWindFieldAndPlumeHeight &wf2);
