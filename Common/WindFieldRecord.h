...
public:
	...
	void	InsertWindField(const CWindFieldAndPlumeHeight &wind);
	...
	RETURN_CODE InterpolateWindField(const CDateTime desiredTime, CWindFieldAndPlumeHeight &desiredWindField);
...
protected:
	...
	CArray <CWindFieldAndPlumeHeight, CWindFieldAndPlumeHeight&> m_windField;
